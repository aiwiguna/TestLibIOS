...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Antoni Wiguna"
  # s.authors            = { "Antoni Wiguna" => "antoni.wiguna@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Antoni Wiguna"
  ...
  s.source_files = "TestLib", "TestLib/**.swift"
